...
- (instancetype)initWithFrame:(CGRect)frame withTitleState:(NSString *)labelType withState:(NSArray *)arrayType withArrayTypeNoOrYes:(NSMutableArray *)arrayTypeNoOrYes withTitleState:(NSString *)labelState withState:(NSArray *)arrayState withArrayStateNoOrYes:(NSMutableArray *)arrayStateNoOrYes withTitleTime:(NSString *)labelTime withTime0:(NSString *)time0 withTime1:(NSString *)time1 with:(NSArray *)array3 withColor:(UIColor *)color {
    ...
    if (self) {
        ...
        self.viewTwo.frame = CGRectMake(0, CGRectGetMaxY(self.viewOne.frame), frame.size.width, 20+CGRectGetMaxY(textField2.frame));
...
- (void)buttonClick3:(UIButton *)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(eChooseViewDelegate:ButtonClick3:withArrayTypeNoOrYes:withArrayStateNoOrYes:withwithTime0:withTime1:)]) {
        [self.delegate eChooseViewDelegate:self ButtonClick3:sender withArrayTypeNoOrYes:_arrayTypeNoOrYes withArrayStateNoOrYes:_arrayStateNoOrYes withwithTime0:_time0 withTime1:_time1];
    }
}
