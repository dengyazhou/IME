...
@interface ShenHeShouPanYiJiaViewController () <UITableViewDelegate,UITableViewDataSource> {
...
@implementation ShenHeShouPanYiJiaViewController
...
//                return 1+1+[_inquiryOrderHttp.tempPriceDetailCount integerValue]+2;
