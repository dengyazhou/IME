...
@interface ECChaKanBaoJiaYiJiaViewController () <UITableViewDelegate,UITableViewDataSource> {
...
@implementation ECChaKanBaoJiaYiJiaViewController
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (tableView.tag == 88) {
        if (section == 0) {
            ...
            double totalPrice = 0;
            totalPrice = [quotationOrderItem.num1 integerValue]*[quotationOrderItem.purchasePrice1 doubleValue];
...
//                    cell.label2.text = _quotationOrderHttp.purchaseSubtotalPrice1?[NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.purchaseSubtotalPrice1 doubleValue]]:@"0.00";
//                    cell.label3.text = _quotationOrderHttp.subtotalPrice1?[NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.subtotalPrice1 doubleValue]]:@"0.00";
//                } else if (indexPath.row < 1+1+1) {
//                    cell.label0.text = @"杂费";
//                    cell.label1.text = [NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.targetCost1 doubleValue]];
//                    cell.label2.text = [NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.purchaseCost1 doubleValue]];
//                    cell.label3.text = [NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.cost1 doubleValue]];
//                } else {
//                    cell.label0.text = @"运费";
//                    cell.label1.text = [NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.targetShipPrice1 doubleValue]];
//                    cell.label2.text = [NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.purchaseShipPrice1 doubleValue]];
//                    cell.label3.text = [NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.shipPrice1 doubleValue]];
//                }
//                return cell;
//            } else if (indexPath.row == 1+1+2) {
...
//                cell.label3.text = _quotationOrderHttp.totalPrice1?[NSString stringWithFormat:@"%.2f",[_quotationOrderHttp.totalPrice1 doubleValue]]:@"0.00";
//                return cell;
//            } else {
//                return nil;
//            }
...
//                cell.label0.text = [NSString stringWithFormat:@"总计(含税价%@%@)",stringTaxRate,@"%"];
            ...
            if (indexPath.row == 0) {
                ...
                cell.zongYiJiaChaKanlabel1.text = [NSString stringWithFormat:@"%.2f",[quotationOrderItem.price1 doubleValue]];
                cell.zongYiJiaChaKanlabel2.text = @"供应商报价";
                cell.zongYiJiaChaKanlabel11.textColor = colorCai;
                cell.zongYiJiaChaKanlabel12.textColor = colorCai;
                cell.zongYiJiaChaKanlabel12.text = [NSString stringWithFormat:@"%.2f",[quotationOrderItem.purchasePrice1 doubleValue]];
