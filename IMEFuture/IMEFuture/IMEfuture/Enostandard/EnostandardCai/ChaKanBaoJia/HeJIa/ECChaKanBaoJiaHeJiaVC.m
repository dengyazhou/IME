...
@interface ECChaKanBaoJiaHeJiaVC () <UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate,UITextFieldDelegate,UITextViewDelegate>{
...
@implementation ECChaKanBaoJiaHeJiaVC
