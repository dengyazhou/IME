...
#define DYZ_multiUserWork_getMultiWorkingOrders [NSString stringWithFormat:@"%@/mes/multiUserWork/getMultiWorkingOrders",DYZBaseURLItem(@"/rs")]

//创建多人报工单
#define DYZ_multiUserWork_createMultiUserWork [NSString stringWithFormat:@"%@/mes/multiUserWork/createMultiUserWork",DYZBaseURLItem(@"/rs")]

//扫描完成获得开工界面
#define DYZ_multiUserWork_getWorkTime [NSString stringWithFormat:@"%@/mes/multiUserWork/getWorkTime",DYZBaseURLItem(@"/rs")]

//开始-暂停-完工接口
#define DYZ_multiUserWork_workLog [NSString stringWithFormat:@"%@/mes/multiUserWork/workLog",DYZBaseURLItem(@"/rs")]

//继续接口
#define DYZ_multiUserWork_continueWork [NSString stringWithFormat:@"%@/mes/multiUserWork/continueWork",DYZBaseURLItem(@"/rs")]
