...
@interface ShouHuoDetailCell090002 ()
...
@implementation ShouHuoDetailCell090002
...
- (void)setModel:(ReceiveBean *)model {
    ...
    self.labelSelfAddress.text = model.deliverOrder.selfAddress;
