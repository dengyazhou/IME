//
//  ZuoYeDanYuanJiaGongXiangQingVC.swift
//  IMEFuture
//
...
class ZuoYeDanYuanJiaGongXiangQingVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelR01.text = routingInspectionVo.workUnitText
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc: ZuoYeDanYuanGongXuXuanZeVC = ZuoYeDanYuanGongXuXuanZeVC()
        vc.routingInspectionVo = routingInspectionVo
        vc.arrayProcessOperationVo = routingInspectionVo.processOperationVoList as! [ProcessOperationVo]!
